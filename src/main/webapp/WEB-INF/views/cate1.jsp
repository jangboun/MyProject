...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="resources/css/cate1.css">
</head>
<body>
 ...
 <header>
	            ...
	            <div class="container">
	                <div class="row">
	                    <div class="col-xl-12">
	                        ...
	                        <a href="/main"><h2 style="text-align:cneter">Catagori</h2></a>
	                        </div>
	                    </div>
	                </div>
	            </div>
							...
							<tr>
								...
								<td class="price">
									<div class="sell_price">
										<strong> <fmt:formatNumber value="${list.itemPrice}" pattern="#,### 원" />
										</strong>
									</div>
								</td>
							</tr>
	...
	<form id="" action="/cate1" method="get">
