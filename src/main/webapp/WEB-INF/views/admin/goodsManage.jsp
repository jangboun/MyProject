                       ...
                       <c:if test="${listcheck != 'empty'}">
                          <table class="goods_table ">
                             <thead >
                              ...
                              <td class="th_column_2">상품 코드</td>
                                   <td class="th_column_3">상품 이름</td>
                                   <td class="th_column_4">상품 가격</td>
                                   <td class="th_column_5">상품 정보</td>
                                   <td class="th_column_6">상품 등록 날짜</td>
                                </tr>
                             </thead>   
                             <c:forEach items="${list}" var="list">
                             <tr>
                                <td><c:out value="${list.itemId}"></c:out></td>
                                <td><c:out value="${list.itemCode}"></c:out></td>
                                <td>
                                ...
                                <td><c:out value="${list.itemInfo}"></c:out></td>
